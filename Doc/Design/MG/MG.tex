...
\item[\refstepcounter{acnum} \actheacnum \label{acUtilites}:] Support for two players to be active at the same time.
...
\item[\refstepcounter{acnum} \actheacnum \label{acGameobject}:] Player object support for a cooperative or adversarial game mode.

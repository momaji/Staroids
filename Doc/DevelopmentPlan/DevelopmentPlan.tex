...
Sept 23 & Moziah & Added Introduction and third party tools\\
...
This document was created to gather all the information required to manage our development of the Staroids software project. It is to be used as an aid throughout the project and  encloses a number of development decisions that have been decided during the inception phase of the project, that we intend to maintain throughout it. 
...
- Details of architecture\\
  dkdiejsk\\
- Third party tool\\
  The only third party tools that we will be using in our demonstration are the internet browsers to test our final implementation on specifically Safari, Internet Explorer, Firefox, and Google Chrome. This is to show that our implementation is compatible with all major web browsers. All other third part tools that are being used throughout the project development however are described in the technology section of the document.\\
...
\end{document}
>>>>>>> 1dedf62e7c678385b06864fdaa8c443e5d85bb0f

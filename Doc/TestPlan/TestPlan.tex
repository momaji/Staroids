...
Input: Pause button and spacebar

Output: Paused state

How test will be performed: In the pre-game state, the pause button is register prohibit progression from the pre-game state to the playing state

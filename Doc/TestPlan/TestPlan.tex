...
Nov 26 & 2.1 & Reviewed for spelling again\\
...
\textcolor{red}{Automated testing will not be used to prove the correctness and validate the Staroids project. It has instead been decided to take a strictly manual approach for various reasons including but not limited to: lack of canvas environment testing framework support, Since it is a video game you are testing for feel and continuity mostly, and user interaction being such an integral part of the project so this should also be thoguht of in how it is tested.}
